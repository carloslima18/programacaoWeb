...
$routes->add('agenda_clinic', new Routing\Route('/agenda',
    [
        '_controller' => '\clinic\Controller\ClinicController::agendaAction'
    ]));


$routes->add('iframe_clinic', new Routing\Route('/Iframe',
    [
        '_controller' => '\clinic\Controller\ClinicController::IframeAction'
    ]));
