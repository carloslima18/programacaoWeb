...
<div id="interface">
    <header id="cabecalho">
        ...
        <nav>
            ...
            <a href="/clinica/front.php/showconsultday">pesquisar consultas pelo cpf e data</a><br/><br/>
            <a href="/clinica/front.php/showconsultall">exibir consultas pelo cpf</a><br/><br/>
            <a href="/clinica/front.php/allconsults">exibir todas as consultas por data</a><br/><br/>
            <a href="/clinica/front.php/deletepatient">apagar paciente</a><br/><br/>
